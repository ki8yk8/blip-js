...
import { registerJumpGameCompletedScene } from "./scenes/jump-game/jump-completed";
import { registerJumpGameScene } from "./scenes/jump-game/jump-game";
import { registerJumpGameUnlockScene } from "./scenes/jump-game/jump-game-unlock";
import { registerJumpGameLevel2Scene } from "./scenes/jump-game/level-2-game";
import { registerJumpGameLevel3Scene } from "./scenes/jump-game/level-3-game";
import { registerJumpGameLevel4Scene } from "./scenes/jump-game/level-4-game";
import { registerJumpGameLevel5Scene } from "./scenes/jump-game/level-5-game";
...
registerJumpGameUnlockScene({ k, constants, state });
...
registerJumpGameLevel3Scene({ k, constants, state });
registerJumpGameLevel4Scene({ k, constants, state });
registerJumpGameLevel5Scene({ k, constants, state });
registerJumpGameCompletedScene({ k, constants, state });
